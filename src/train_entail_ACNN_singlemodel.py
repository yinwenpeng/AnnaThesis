...
from common_functions import Conv_for_Pair_Multi_Perspective,create_ensemble_para_with_bounds, Conv_for_Pair,dropout_layer, store_model_to_file, elementwise_is_two,Conv_with_Mask_with_Gate, Conv_with_Mask, create_conv_para, L2norm_paraList, ABCNN, create_ensemble_para, cosine_matrix1_matrix2_rowwise, Diversify_Reg, Gradient_Cost_Para, GRU_Batch_Tensor_Input_with_Mask, create_LSTM_para
'''
1, use SVM outside
...
def evaluate_lenet5(learning_rate=0.02, n_epochs=4, L2_weight=0.0000001, extra_size=4, use_svm=False, drop_p=0.1, div_weight=0.00001, emb_size=300, 
                    batch_size=50, filter_size=[3,3], maxSentLen=40, hidden_size=[300,300], margin =0.1, comment='five copies, sum&majority'):
...
#                     drop_conv_W_2_pre,conv_b_2_pre,drop_conv_W_2_gate,conv_b_2_gate,
#                     drop_conv_W_2,conv_b_2,drop_conv_W_2_context, conv_b_2_context,
                   labels):
...
#         euc_sum = 1.0/(1.0+T.sqrt(1e-20+T.sum((conv_layer_1.attentive_sumpool_vec_l-conv_layer_1.attentive_sumpool_vec_r)**2, axis=1))).dimshuffle(0,'x')
        ...
        HL_layer_1_input = T.concatenate([attentive_sent_emb_l,attentive_sent_emb_r, attentive_sent_emb_l*attentive_sent_emb_r],axis=1)
        ...
        para_0 = LR_para+HL_layer_1.params+HL_layer_2.params

      
#         loss = loss_0+loss_1+loss_2
        batch_distr = layer_LR.p_y_given_x
...
#                                                                                     drop_second_conv_W_pre,second_conv_b_pre,drop_second_conv_W_gate,second_conv_b_gate,
#                                                                                     drop_second_conv_W,second_conv_b,drop_second_conv_W_context,second_conv_b_context, 
                                                                                    first_labels)
