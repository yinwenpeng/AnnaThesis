...
def evaluate_lenet5(learning_rate=0.01, n_epochs=100, L2_weight=0.000001, drop_p=0.05, emb_size=300, hidden_size = 500, batch_size=5, filter_size=[3,5,7], maxSentLen=40, comment='maxlen 40'):
    ...
    all_sentences, all_masks, all_labels, word2id=load_sentiment_dataset(maxlen=maxSentLen, minlen=2)  #minlen, include one label, at least one word in the sentence
